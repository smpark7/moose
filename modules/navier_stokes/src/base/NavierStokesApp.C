...
NavierStokesApp::registerObjects(Factory & factory)
{
  ...
  registerKernel(INSMomentumTurbulentViscosityLaplaceForm);
  registerKernel(INSMomentumTurbulentViscosityTractionForm);
  registerKernel(INSK);
  registerKernel(INSEpsilon);
  registerKernel(INSScalarTransportTimeDerivative);
  registerKernel(INSMomentumSUPG);
  registerKernel(INSScalarSUPG);
  registerKernel(INSScalarArtDiff);
  ...
  registerBoundaryCondition(INSMomentumShearStressWallFunctionBC);
  registerBoundaryCondition(INSMomentumNoBCBCTurbulentTractionForm);
  registerBoundaryCondition(INSEpsilonWallFunctionBC);
