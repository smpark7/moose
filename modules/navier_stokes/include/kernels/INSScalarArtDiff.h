...
/****************************************************************/
#ifndef INSSCALARARTDIFF_H
#define INSSCALARARTDIFF_H

#include "Kernel.h"
#include "ScalarTransportBase.h"

// Forward Declarations
class INSScalarArtDiff;

template <>
InputParameters validParams<INSScalarArtDiff>();
 ...
 * instead.
 */
class INSScalarArtDiff : public Kernel, ScalarTransportBase
{
public:
  INSScalarArtDiff(const InputParameters & parameters);

  virtual ~INSScalarArtDiff() {}
