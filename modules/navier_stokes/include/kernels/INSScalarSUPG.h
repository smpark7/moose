...
/****************************************************************/
#ifndef INSSCALARSUPG_H
#define INSSCALARSUPG_H
...
template <>
InputParameters validParams<INSScalarSUPG>();
 ...
 * instead.
 */
class INSScalarSUPG : public Kernel, ScalarTransportBase
{
public:
  INSScalarSUPG(const InputParameters & parameters);

  virtual ~INSScalarSUPG() {}
